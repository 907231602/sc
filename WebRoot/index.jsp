...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>selectcourse/css/compiled/signin.css" type="text/css" media="screen" />
...
<body style="background-color: #A0CEE5">
    ...
    <%--<div class="bg-switch visible-desktop">
         <div class="bgs">
            <a href="#" data-img="landscape.jpg" class="bg active">
                <img src="<%=basePath%>selectcourse/img/bgs/landscape.jpg" />
            </a>
            <a href="#" data-img="blueish.jpg" class="bg">
                <img src="<%=basePath%>selectcourse/img/bgs/blueish.jpg" />
            </a>            
            <a href="#" data-img="7.jpg" class="bg">
                <img src="<%=basePath%>selectcourse/img/bgs/7.jpg" />
            </a>
            <a href="#" data-img="8.jpg" class="bg">
                <img src="<%=basePath%>selectcourse/img/bgs/8.jpg" />
            </a>
            <a href="#" data-img="9.jpg" class="bg">
                <img src="<%=basePath%>selectcourse/img/bgs/9.jpg" />
            </a>
            <a href="#" data-img="10.jpg" class="bg">
                <img src="<%=basePath%>selectcourse/img/bgs/10.jpg" />
            </a>
            <a href="#" data-img="11.jpg" class="bg">
                <img src="<%=basePath%>selectcourse/img/bgs/11.jpg" />
            </a>
        </div> 
    </div>--%>
    ...
    <div class="row-fluid login-wrapper">
       ...
       <img class="logo" src="<%=basePath%>selectcourse/img/logo.png" />
     ...
     alert("你输入的账户不存在或者密码错误！");
        ...
        <form action="<%=basePath%>loginsc_studentdenglu.action" onsubmit="return checkDenglu()" method="post">
            <div class="content-wrap">
              ...
              <input class="span8" type="text" name="yanzhengCode" maxlength=4 placeholder="验证码">  <img border=0 src="<%=basePath%>selectcourse/image.jsp" onclick="this.src=this.src+'?'">    
               <!--  <a href="#" class="forgot">忘记密码?</a> -->
                <div class="remember">
                    <input type="checkbox" name="cbox" value="1" onClick="chooseOne(this);" />
                    <label for="remember-me">教师</label>
                    <input type="checkbox" name="cbox" value="2" onClick="chooseOne(this);" checked="checked" />
                    <label for="remember-me">学生</label>
                    <input type="checkbox" name="cbox" value="3" onClick="chooseOne(this);" />
