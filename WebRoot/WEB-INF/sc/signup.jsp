    ...
    <div class="row-fluid login-wrapper">
        ...
        <form action="<%=basePath%>rigister_zhuce.action" onsubmit="return checkform()" method="post">
            <div class="content-wrap">
                <h6>注册</h6>
                 <input class="span12" onclick="clickMe()" type="text" id="studentName" name="students.studentName" placeholder="姓名" />
...
<script src="<%=basePath%>selectcourse/js/jquery-1.8.1.js"></script>
</body>
<script type="text/javascript">
